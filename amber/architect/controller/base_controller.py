...
class BaseController(BaseSearcher):
    ...
    def sample(self, decode=False):
        """
        Get a sampled architecture/action and its corresponding probabilities given current 
        controller policy parameters, e.g. amber.architect.controller.RecurrentRLController()
    ...
    def store(self, state=None, prob=None, action=None, reward=None):
        ...
        This is the receiving method for controller to interact with manager by storing the rewards 
